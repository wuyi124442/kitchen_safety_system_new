    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', '管理员'), ('operator', '操作员'), ('viewer', '查看者')], default='viewer', max_length=20, verbose_name='用户角色')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dashboard_refresh_interval', models.IntegerField(default=5, verbose_name='仪表板刷新间隔(秒)')),
